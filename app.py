...
myheading1 = f"That's yummy {mycolumn}!"
mygraphtitle = '2011 US Agriculture Exports by State'
mycolorscale = 'bluered' # Note: The error message will list possible color scales.
mycolorbartitle = "Millions USD"
tabtitle = 'Old McDonald'
sourceurl = 'https://plot.ly/python/choropleth-maps/'
githublink = 'https://github.com/szilviaaltorjai/dash-map-usa-agriculture'
